...
//  //to add products
    public void addProduct() {
        String menu = "Select Product Type:" +
...
//  //to edit products
    public void editProduct() {
        ...
        while (menuOption != 0) {
            ...
            System.out.print("Choose the product number you want to edit:" +
                    "\n0: Go Back");
    ...
    public void editWBP(Product product) {
        ...
        String menu = "Select the field you want to edit:" +
                "\n0: Go Back" +
...
//  //to remove or delete products
    public void deleteProduct() {
        ...
        while (menuOption != 0) {
            ...
            System.out.print("Choose the product number you want to delete:" +
                    "\n0: Go Back");
